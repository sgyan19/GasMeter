...
/**
 * A class similar but unrelated to android's {@link AsyncTask}.
 *
 * Unlike AsyncTask, this class properly propagates exceptions.
 *
 * If you're familiar with AsyncTask and are looking for {@link AsyncTask#doInBackground(Object[])},
